...
class Clothing(models.Model):
    ...
    preview_image_back = models.ImageField(blank=True, null=True)
    preview_image_live = models.ImageField(blank=True, null=True)
    header = models.CharField(max_length=50, default="")
    description = models.TextField(max_length=500, default="Description field")
